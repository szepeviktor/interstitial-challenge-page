...
defined('HASHCASH_INTERSTITIAL_BITS') || define('HASHCASH_INTERSTITIAL_BITS', 8);
defined('HASHCASH_INTERSTITIAL_CHALLENGE_TTL') || define('HASHCASH_INTERSTITIAL_CHALLENGE_TTL', 60);
